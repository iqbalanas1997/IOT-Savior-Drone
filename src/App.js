      ...
      <AppContext.Provider value={{ setPage, socket }}>
        <div className="p-3">
          ...
          <p className="text-base">
            Server Connection: {currentTime ? currentTime : "Failed"}
          </p>
        </div>
        ...
        <>
          ...
          {page === "stats" && (
            <MissionStats flightStats={flightStats} col={col} row={row} />
          )}
          ...
          <div
            ref={myRef}
            className="flex flex-row text-center justify-center my-10"
          >
            <button
              onClick={() => setPage("log")}
              className={
                "focus:outline-none" +
                (page === "log" ? " text-blue-500" : " text-black")
              }
            >
              <BsFillChatSquareDotsFill className="text-4xl mx-5 md:mx-10" />
            </button>
            <button
              onClick={() => setPage("stats")}
              className={
                "focus:outline-none" +
                (page === "stats" ? " text-blue-500" : " text-black")
              }
            >
              <BsBarChartFill className="text-4xl mx-5 md:mx-10" />
            </button>
            <button
              onClick={() => setPage("functions")}
              className={
                "focus:outline-none" +
                (page === "functions" ? " text-blue-500" : " text-black")
              }
            >
              <AiFillControl className="text-4xl mx-5 md:mx-10" />
            </button>
            <button
              onClick={() => setPage("camera")}
              className={
                "focus:outline-none" +
                (page === "camera" ? " text-blue-500" : " text-black")
              }
            >
